...
app.post("/user/signup",async(req,res)=> {
    ...
    const data=new User({name:req.body.name,email:req.body.email,dob:req.body.dob,password:req.body.password});
...
app.post("/module1/add",async(req,res)=>{
    try{
        console.log(req.body);
        const moduledata=new module1({question:req.body.question,options:req.body.options,answer:req.body.answer});
